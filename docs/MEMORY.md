...
| ADR-005 | Hot-reload via IpcAction::ReloadCommands | Existing WebSocket IPC path used — no new Event Bus events needed; scripts virtual cmds merged into intent reinit | 2026-03-14 |
...
- **Last milestone:** TASK-006 Hot-reload — commands/index.svelte calls reload_jarvis_commands after CRUD; ReloadCommands handler merges script virtual cmds into intent reinit (2026-03-14)
